...
#Loop for make the following process for each country inside the list (this is, when all the code below will run for each item of the list)
for (i in 1:length(cod_countries)){ 
  
  country = cod_countries[i] #This save the current position of the list inside the variable country
