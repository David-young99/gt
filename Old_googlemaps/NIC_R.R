...
#Paths
in_path_shp = file.path("/home/dyoung/gitrepo/gt/Archivo_CA/adm2_by_country/")
out_path_shp = file.path("/home/dyoung/outputs/")

country = "NIC"

#Paths
#in_path_shp = file.path("C:\\Users\\David\\OneDrive - Universidad de Costa Rica\\Personal\\Scripts\\R Studio\\gt\\Archivo_CA\\adm2_by_country\\")
